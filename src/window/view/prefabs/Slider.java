...
public class Slider {
    ...
    public static JSlider createSlider(int width, int height, int maxVal, SaveInt<Integer> saveInt, MethodBody method){
        ...
        ThemeManager.repaintParentTree(slider);
    ...
    private static class CustomSliderUI extends BasicSliderUI {
        ...
        private static final int TRACK_HEIGHT = trackHeight;
        private static final int TRACK_WIDTH = sliderWidth;
        private static final int TRACK_ARC = sliderBorderRound;
        private static final Dimension THUMB_SIZE = new Dimension(thumbWidth, thumbHeight);
        ...
        public void paintThumb(final Graphics g) {
            g.setColor(primaryThemeColor.getValue().darker());
